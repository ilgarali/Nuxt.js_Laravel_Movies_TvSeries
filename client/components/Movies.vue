    ...
    <b-row no-gutters>
      <b-col v-for="(movie, index) in datas" :key="index" cols="md-3 col-12 col-sm-6 my-2">
        <div class="main-content ml-3">
          ...
          <div class="img" v-if="movie.sources">
            <div class="language-info">
              <div  class="lanuguage-detail d-flex justify-content-end">
                <div v-if="movie.sources.dublaj" class="dublaj"></div>

                <div v-if="movie.sources.altyazi" class="subtitle">
            ...
            <div class="details p-1">
              <nuxt-link :to="'film/' + movie.movie_slug">
